    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h1 class="display-5">Los mejores Efectos de Iluminación</h1>
          <p>La calidad del conjunto de la iluminación y su efecto sobre el estado de ánimo
          a menudo depende de la relación entre las luces principales y de relleno...</p>
        </div>
      </div>
      <div class="carousel-item ">
        <img class="d-block w-100" src="assets/picture/cesourel/location.jpg" alt="First slide">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="display-5 text-dark">Un sistema de carreteras y transportes bien conectado</h1>
          <p class="text-dark">Fácil accesibilidad a puntos comerciales y zonas clave de la ciudad con la mejor zona de parqueo...</p>
        </div>
      </div>
      <div class="carousel-item ">
...
<section class="py-5 colored-section" id="grid">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-6 col-md-4 cd-lg-4">
        <div class="box container text-center">
          <img class='img mb-4' src='assets/picture/common/accomadation.jpg' alt='Image Error' width='350px'
            height='200px'>
          <center>
            <h3>ACCOMMODATION</h3>
          </center>
      ...
      <div class="col-xs-12  col-sm-6 col-md-4 cd-lg-4">
        <div class="box container text-center">
          ...
          <p class="mb-4">Ten distinct dining destinations featuring Indian & international cuisine along with some of
            the world's most well appreciated and prized beverages.</p>
    ...
    <div class="row">
      ...
      <div class="col-xs-12  col-sm-6 col-md-4 cd-lg-4">
        <div class="box container text-center">
          ...
          <p class="mb-4">Embodying our commitment to holistic wellbeing, ITC Grand Chola offers facilities that provide
            healthier options for a better stay.</p>
      ...
      <div class="col-xs-12  col-sm-6 col-md-4 cd-lg-4">
        <div class="box container text-center">
          ...
          <center>
            <h2>SUITE SOJOURNS</h2>
          </center>
          <p class="mb-4">Exceptional value for a superlative suite experience with airport transfers, Wi-Fi, breakfast
            and more.</p>
