    ...
    <nav id="navbar_top" class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand " href="#"><i
                    class="fa-solid fa-hotel"></i><?php echo $general_setting['Name'] ?></a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown"
                            ...
                            <img src="http://localhost/HotelDash_Web/assets/picture/profiles/<?php echo $user_details['ProfileImage']; ?>"
                                width="40" height="40" class="rounded-circle" alt="Perfil de Usuario" />
