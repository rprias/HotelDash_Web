    ...
    <div class="container-fluid " id="contentArea">
        <div class="col-9">
            ...
            <form id="updateUser" method="POST" action="admin_functions.php" enctype="multipart/form-data"
                ...
                <input type="" id="user_Id" name="updateAccount" value="<?php echo $_SESSION['loggedUserId'];?>">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <div class="input-group ">
                            ...
                            <input id="updateNombre" type="text" name="updatenombre" placeholder="Nombre Completo"
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <div class="input-group ">
                            ...
                            <select id="updateRol" name="updateRol"
        ...
        <div class="col-9">
            ...
            <form id="change_password" autocomplete="on">
                ...
                <div class="input-group col-lg-12 mb-4">
                    ...
                    <input id="oldPassword" type="password" name="oldPassword" placeholder="Contraseña Actual"
                        class="form-control bg-white border-left-0 border-md" required>
                </div>
